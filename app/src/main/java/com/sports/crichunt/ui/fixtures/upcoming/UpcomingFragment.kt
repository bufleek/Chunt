...
class UpcomingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainViewModel.upcomingFixturesRequestState.observe(viewLifecycleOwner, {
        ...
        mainViewModel.getUpcomingFixtures()
    }

    private fun showEmptyState() {
        states.addView(View.inflate(requireContext(), R.layout.item_empty_state, null).apply {
            findViewById<TextView>(R.id.tv_empty_message).text = "There are no upcoming matches to display"
        })
    }
